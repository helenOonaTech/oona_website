...
function MemberCard({
  ...
  return (
    <>
      {active ? (
        <section className="member_card md:w-[500px] w-[300px] md:h-[263px] relative text-left  py-4 md:px-6 px-4 transition-all">
          <div className="flex md:gap-5 gap-3 transition-all">
            <div
          ...
          <p className="text-[#918C8C] transition-all md:text-sm text-xs font-normal md:leading-[23px]  leading-5 md:-mt-[66px] -mt-[55px]">
            {description}
          </p>
          <div className="flex items-center gap-4 md:mt-6 mt-4 transition-all">
            <Link
              to="#"
          ...
          <div className="flex items-center gap-[1px] transition-all absolute -bottom-3 md:right-10 right-3">
            <button
