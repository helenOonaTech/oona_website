...
function CustomersRate() {
  return (
    <section className="text-center md:px-52 px-7">
      <h3 className="text-lg text-[#202020] font-bold leading-[22px]">
        Esther Howard
      </h3>
      <span className="font-normal text-[#959595] text-base leading-[22px]">
        Marketing Coordinator
      </span>
      <p className="text-sm text-[#202020] font-normal leading-[22px]">
